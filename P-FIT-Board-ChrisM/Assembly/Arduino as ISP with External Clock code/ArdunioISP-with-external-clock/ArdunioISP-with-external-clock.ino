...
/*
    Modififed so pin 8 is the reset pin for programming
    this allows safe usage of timer1 and pins 10 & 9
    without accidentally reseting or triggering slave select
    on target AVR
*/
// ArduinoISP
...
#define RESET     8 // Use pin 10 to reset the target rather than SS
#define LED_HB    9
#define LED_ERR   8
#define LED_PMODE 7
...
void setup() {
  ...
  // Generate clock signal on pin 10 while programmin
  Timer1.initialize(1);
  Timer1.pwm(10, 511);
